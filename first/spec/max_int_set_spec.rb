...
describe MaxIntSet do
  subject(:max_int_set) { MaxIntSet.new(4) }
  ...
  describe "#initialize" do
    ...
    it "should initialize the store to the max length" do
      expect(max_int_set.store.length).to eq(4)
    end

    it "should initialize all the store to false" do
  ...
  describe "#insert" do
    ...
    it "raises an error if attempt to add outside of range" do
